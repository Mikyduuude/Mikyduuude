...
score_surf = test_font.render('My Game', False, (64, 88, 120))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                player_gravity = -10  # Increase negative value for upward movement

    player_gravity += 1  # Apply gravity
    player_rect.y += player_gravity  # Update player's position based on gravity
